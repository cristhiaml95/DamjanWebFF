                                                                  ...
                                                                  options: List<
                                                                      ...
                                                                      clientDDClientsRowList
                                                                          .map((e) =>
                                                                              e.id)
                                                                          .toList()),
                                                                  optionLabels: clientDDClientsRowList
                                                                      .map((e) =>
                                                                          e.client)
                                                                      .toList(),
                                                                  onChanged: (val) =>
                                                      ...
                                                      children: [
                                                        AutoSizeText(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'le5vzwe0' /* Internal reference number - cu... */,
                                                          ),
                                                          textAlign:
                                                              TextAlign.center,
                                                          style: FlutterFlowTheme
                                                      ...
                                                      children: [
                                                        AutoSizeText(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'egsqs1qd' /* Internal number - accounting: ... */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                      ...
                                                      children: [
                                                        Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'jd1nxnxr' /* Loading gate sequence:   */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                            ...
                                                            child:
                                                              ...
                                                              options: [
                                                                ...
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'av72bxme' /* ovijanje-folija */,
                                                                ),
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'ycapl6g3' /* povezovanje */,
                                                                )
                                                              ],
                                                              onChanged: (val) =>
                                                                  setState(() =>
